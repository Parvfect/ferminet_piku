...
if __name__ == '__main__':
    ...
    # Inference config
    cfg.optim.iterations = 322000
    cfg.log.save_freq = 2000000
    cfg.log.save_tfreq = 235
    cfg.log.restore_path = "/projects/u6em/parv/diamond/unpaired/classical/bc"
    cfg.log.save_path = "/projects/u6em/parv/diamond/unpaired/classical/bc/inference"
    cfg.observables.positions = True
    cfg.observables.srpd.calculate = False
